...
```
Arduino Uno has 14 digital GPIO pins. GPIO (General Purpose Input/Output) pins allow the Arduino to read sensors (input) and control devices like LEDs or motors (output).
